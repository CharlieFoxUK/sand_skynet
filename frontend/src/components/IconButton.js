...
class IconButton extends Component {
    ...
    renderButton() {
        ...
        if (this.props.children !== undefined && this.props.children !== "")
            return <Button className={this.props.className} style={this.props.style} onClick={(evt) => { if (this.props.onClick !== undefined) this.props.onClick(evt); }}>
                <div className="d-flex">
                    {icon}
                    {text}
                </div>
            </Button>
        else return <Button className={this.props.className} style={this.props.style} onClick={(evt) => { if (this.props.onClick !== undefined) this.props.onClick(evt); }}>
            <div className="d-flex">
                {icon}
            </div>
        </Button>
